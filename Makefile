...
install:: wmtimebomb
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  wmtimebomb $(DESTDIR)$(BINDIR)/wmtimebomb

install.man:: wmtimebomb.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) wmtimebomb.man $(DESTDIR)$(MANDIR)/wmtimebomb.$(MANSUFFIX)
